...
class twochoice(tk.Frame):
     def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text= "Correct Information", font= ("Museo Sans 900", 20), fg= "green",
        command= lambda: controller.show_frame("start"))
        button1.pack(side= "bottom", fill= "x", pady=5)
        button2 = tk.Button(self, text= "Incorrect Information", font= ("Museo Sans 900", 20), fg= "red",
        command= lambda: controller.show_frame("start"))
